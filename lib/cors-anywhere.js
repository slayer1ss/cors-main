...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    removeHeaders: ['cdn-loop','do-connecting-ip','cf-ray','cf-visitor','cf-ew-via','cf-ipcountry','cf-connecting-ip'],              // Strip these request headers.
  ...
  return function(req, res) {
    ...
    else{['kuponuna','canlitribun','sporyayinlari','developer-tools.jwplayer.com','matchcenter.laola1.at'].forEach(function(item){if(origin.includes(item)){origin_matched=1;}});}
    if(origin_matched==0){
...
*/
    ...
    var lh=location.host,src="";
    if(lh=="1xstavka.ru"){src="https://1xstavka.ru";}
    else if(lh.includes("mackolikfeeds.com")){src="https://www.mackolik.com";}
    else if(lh.includes("sportscentral.io")){src="https://footybite.cc";}
    else if(lh.includes("azureedge.net")||lh.includes("azurefd.net")||lh.includes("cloudfront.net")||lh.includes("nonsavefiles.xyz")){src="http://weakstreams.com";}
    else if(lh.includes(".xyz")){src="https://onbahis1.tv";}
    else if(lh.includes("sportradar.com")){src="https://matchcenter.laola1.at";}

    delete req.headers["Origin"];delete req.headers["origin"];
    if(src!=""){req.headers["Referer"]=src+"/";req.headers["Origin"]=src;}

    console.log("satır 455");
