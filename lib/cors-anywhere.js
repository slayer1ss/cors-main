...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  //console.dir(proxyRes,{depth:null});
...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    if (!/^\/https?:/.test(req.url) && !isValidHostName(location.hostname)) {
      ...
      var reqpath="";
      if (req.url === '/AssetsLive/assets/js/TvPlay.js') {reqpath="remote-files/betist/TvPlay.js";}
      else if (req.url === '/AssetsLive/assets/js/tvxlive.js') {reqpath="remote-files/betist/tvxlive.js";}
      else if (req.url === '/AssetsLive/assets/js/tvxlive-init.js') {reqpath="remote-files/betist/tvxlive-init.js";}
      else if (req.url === '/AssetsLive/assets/vendor/jquery/dist/jquery.min.js') {reqpath="remote-files/betist/jquery.min.js";}
      else if (req.url === '/AssetsLive/assets/vendor/bootstrap/dist/js/bootstrap.min.js') {reqpath="remote-files/betist/bootstrap.min.js";}
      else if (req.url === '/AssetsLive/assets/vendor/light/jquery.allofthelights-min.js') {reqpath="remote-files/betist/jquery.allofthelights-min.js";}
      else if (req.url === '/AssetsLive/assets/vendor/clappr/clappr.ext.js?v=7') {reqpath="remote-files/betist/clappr.ext.js";}
      else if (req.url === '/AssetsLive/assets/vendor/bootstrap/dist/css/bootstrap.min.css') {reqpath="remote-files/betist/bootstrap.min.css";}
      else if (req.url === '/AssetsLive/assets/vendor/ionicons/css/ionicons.min.css') {reqpath="remote-files/betist/ionicons.min.css";}
      else if (req.url === '/AssetsLive/assets/vendor/news/breaking-news-ticker.css') {reqpath="remote-files/betist/breaking-news-ticker.css";}
      else if (req.url === '/AssetsLive/assets/css/tvxlive.css') {reqpath="remote-files/betist/tvxlive.css";}
      else if (req.url === '/AssetsLive/assets/css/custom.css?v=3') {reqpath="remote-files/betist/custom.css";}
      else if (req.url === '/AssetsAdmin/vendors/bower_components/sweetalert/dist/sweetalert.css') {reqpath="remote-files/betist/sweetalert.css";}
      else if (req.url === '/laola/licensing') {reqpath="remote-files/betradar/license.txt";}
    ...
    var origin_matched=0;
    if(origin==""){origin_matched=1;console.log("Origin: YOK");}
    else{['kuponuna','canlitribun','sporyayinlari','developer-tools.jwplayer.com'].forEach(function(item){if(origin.includes(item)){origin_matched=1;}});}
    if(origin_matched==0){
...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){req.headers["Referer"] = "http://weakstreams.com";}
    else if(lh=="1xstavka.ru"){req.headers["Referer"] = "https://1xstavka.ru";}
    else if(lh=="trafficdok.com"){req.headers["origin"] = "https://z.cdn.trafficdok.com";}
    else if(lh=="blacktiecdn.xyz"){req.headers["Referer"] = "http://blacktiesports.net";}
    else if(lh=="cantholdus.xyz"){req.headers["Referer"] = "https://www.streameast.live";}
    else if(lh.includes("sportscentral.io")){req.headers["Referer"] = "https://footybite.cc/";req.headers["origin"] = "https://footybite.cc";}
    else if(
      lh.includes("ileqys.xyz")||lh.includes("gedorn.xyz")||lh.includes("qelkei.xyz")||lh.includes("vahaqi.xyz")||lh.includes("ypyfis.xyz")||
      
      
      
      lh.includes("heunao.xyz")||lh.includes("zonvou.xyz")||lh.includes("betyve.xyz")||lh.includes("essorw.xyz")||lh.includes("ulpenr.xyz")||
      lh.includes("lerusf.xyz")||lh.includes("arpesk.xyz")||lh.includes("diyavo.xyz")||lh.includes("doqyxe.xyz")||lh.includes("umland.xyz")||
      lh.includes("teisuy.xyz")||lh.includes("xiyend.xyz")||lh.includes("egsirl.xyz")||lh.includes("axihin.xyz")||lh.includes("poarai.xyz")||
      lh.includes("eciwar.xyz")||lh.includes("seaboe.xyz")||lh.includes("coquss.xyz")||lh.includes("iblinv.xyz")||lh.includes("ewsill.xyz")||
      lh.includes("payyld.xyz")||lh.includes("kenvue.xyz")||
      
      lh.includes("kasgoe.xyz")||lh.includes("looseu.xyz")||lh.includes("venjai.xyz")||lh.includes("kaqurk.xyz")||lh.includes("fiemuy.xyz")||
      lh.includes("osxulp.xyz")||lh.includes("ekyzyn.xyz")||lh.includes("ulsorg.xyz")||lh.includes("jaukui.xyz")||lh.includes("tezegy.xyz")||
      lh.includes("ruvesy.xyz")||lh.includes("vyopau.xyz")||lh.includes("vangoy.xyz")||lh.includes("qousau.xyz")||lh.includes("irwirf.xyz")||
      lh.includes("zeoyyo.xyz")||lh.includes("neiriu.xyz")||lh.includes("unhant.xyz")||lh.includes("ozrold.xyz")||lh.includes("gasmiu.xyz")
    ){req.headers["Referer"] = "https://standarttv.com/";req.headers["origin"] = "https://standarttv.com";}
    else if(lh=="chupachichi2.site"){req.headers["Referer"] = "https://www.tutele.sx/";req.headers["origin"] = "https://www.tutele.sx";}
