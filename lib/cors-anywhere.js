...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("azurefd.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){req.headers["Referer"] = "http://weakstreams.com";}
      ...
      lh.includes("oquvyr.xyz")||lh.includes("boyoho.xyz")||lh.includes("yluxas.xyz")||lh.includes("olqall.xyz")||lh.includes("uspasc.xyz")||
      lh.includes("vifupy.xyz")||lh.includes("xoahuu.xyz")||lh.includes("yrzint.xyz")||lh.includes("porcoi.xyz")||lh.includes("ciasua.xyz")||
      lh.includes("sariss.xyz")||lh.includes("iqyrill.xyz")||lh.includes("anhurm.xyz")||lh.includes("derezo.xyz")||lh.includes("innyrc.xyz")||
      lh.includes("ayyrel.xyz")||lh.includes("dolpui.xyz")||lh.includes("ascalw.xyz")||lh.includes("olcynw.xyz")||lh.includes("jailia.xyz")||
      lh.includes("exrers.xyz")||lh.includes("nuyysf.xyz")||lh.includes("neyfie.xyz")||

      lh.includes("astorj.xyz")||lh.includes("dujapy.xyz")||lh.includes("idnisn.xyz")||lh.includes("ulrunx.xyz")||lh.includes("wyminj.xyz")||
      lh.includes("ydozyr.xyz")
