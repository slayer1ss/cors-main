...
function getHandler(options, proxy) {
  var corsAnywhere = {
    ...
    originWhitelist: ['mobil.kuponuna3.com','kuponuna3.com','mobil.canlitribun.com','canlitribun.com'],            // If non-empty, requests not from an origin in this list will be blocked.
  ...
  return function(req, res) {
    ...
    if(location.host=="web.savefiless.xyz"){req.headers["Referer"] = "http://liveonscore.tv";}    
