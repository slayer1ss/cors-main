...
function getHandler(options, proxy) {
  ...
  return function(req, res) {
    ...
    else{['kuponuna','canlitribun','sporyayinlari','developer-tools.jwplayer.com'].forEach(function(item){if(origin.includes(item)){origin_matched=1;}});console.log("Origin: "+origin);}
    if(origin_matched==0){
      res.writeHead(403, 'Forbidden', cors_headers);
...
*/
    ...
    else if(lh.includes("petlefy.com")){req.headers["Referer"] = "https://betnano12tv.com/";req.headers["Origin"] = "https://betnano12tv.com";}   
    
    else if(lh.includes("radorecon.com")){req.headers["Referer"] = "https://betisttv55.com/";req.headers["Origin"] = "https://betisttv55.com";}   
    else if(lh.includes("luxleft.com")||lh.includes("petlefy.com")){req.headers["Referer"] = "https://betisttv63.com/";req.headers["Origin"] = "https://betisttv63.com";}
    else if(lh.includes("ananinamikanka")){req.headers["Referer"] = "http://inanamiyorumhalaburdasin.cloud/";req.headers["Origin"] = "http://inanamiyorumhalaburdasin.cloud";}
