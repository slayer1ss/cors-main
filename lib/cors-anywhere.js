...
function withCORS(headers, request) {
  ...
  //headers['X-Final-Url'] = 'https://www.canlitribun26.com';
  //headers['X-Frame-Options'] = 'https://www.canlitribun26.com';
  //headers['X-Request-Url'] = 'https://www.canlitribun26.com';
...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){req.headers["Referer"] = "http://weakstreams.com";}
      ...
      lh.includes("oskass.xyz")||lh.includes("siukio.xyz")||lh.includes("tezegy.xyz")||lh.includes("cuvayo.xyz")||lh.includes("vangoy.xyz")||
      lh.includes("ruvesy.xyz")||lh.includes("jaukui.xyz")||lh.includes("vyopau.xyz")||lh.includes("qousau.xyz")||lh.includes("gasmiu.xyz")||
        
      
      lh.includes("cerkou.xyz")||lh.includes("azuryl.xyz")||lh.includes("nubivo.xyz")||lh.includes("acutel.xyz")||lh.includes("pesobi.xyz")||
      lh.includes("beskee.xyz")||lh.includes("miquka.xyz")||lh.includes("ernonq.xyz")||lh.includes("kacold.xyz")||lh.includes("naeway.xyz")||
      lh.includes("esilor.xyz")||lh.includes("meluny.xyz")||lh.includes("aynonp.xyz")||lh.includes("ezsylt.xyz")||lh.includes("oticar.xyz")||
      lh.includes("allenm.xyz")||lh.includes("gyubyu.xyz")||lh.includes("larboi.xyz")||lh.includes("olehos.xyz")||lh.includes("ivlusw.xyz")
