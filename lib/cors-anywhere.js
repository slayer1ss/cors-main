...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){req.headers["Referer"] = "http://weakstreams.com";}
      ...
      lh.includes("teisuy.xyz")||lh.includes("betyve.xyz")||lh.includes("eciwar.xyz")||lh.includes("ulpenr.xyz")||lh.includes("egsirl.xyz")||
      lh.includes("essorw.xyz")||lh.includes("seaboe.xyz")||lh.includes("poarai.xyz")||lh.includes("xiyend.xyz")||lh.includes("axihin.xyz")||
      lh.includes("ewsill.xyz")||lh.includes("doqyxe.xyz")||lh.includes("arpesk.xyz")||lh.includes("heunao.xyz")||lh.includes("coquss.xyz")||
      lh.includes("diyavo.xyz")||lh.includes("umland.xyz")||
