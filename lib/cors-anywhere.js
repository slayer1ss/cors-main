...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){
      req.headers["Referer"] = "http://weakstreams.com";
    }
    ...
    else if(lh.includes("ananinamikanka")){
      req.headers["Referer"] = "http://inanamiyorumhalaburdasin.cloud/";
      req.headers["Origin"] = "http://inanamiyorumhalaburdasin.cloud";
    }
