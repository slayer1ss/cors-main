...
*/
    ...
    if(lh.includes("savefiless.xyz")||lh.includes("nonsavefiles.xyz")||lh.includes("azureedge.net")||lh.includes("cloudfront.net")||lh.includes("nbastreamxyz.xyz")){req.headers["Referer"] = "http://weakstreams.com";}
      ...
      lh.includes("sprimper.xyz")||lh.includes("gonzory.xyz")||lh.includes("cutepper.xyz")||lh.includes("petlefy.xyz")||lh.includes("fadoran.xyz")||
      lh.includes("humible.xyz")||lh.includes("warmino.xyz")||lh.includes("tayiton.xyz")||lh.includes("popdank.xyz")||lh.includes("luxleft.xyz")||
      lh.includes("cerkou.xyz")||lh.includes("azuryl.xyz")||lh.includes("nubivo.xyz")||lh.includes("acutel.xyz")||lh.includes("pesobi.xyz")||
      lh.includes("beskee.xyz")||lh.includes("miquka.xyz")||
      
      
      
      lh.includes("leftbite.com")||lh.includes("hellant.com")||lh.includes("radorecon.com")||lh.includes("lavavish.com")||
      lh.includes("prexxic.com")||lh.includes("ramoflas.com")||lh.includes("sanorack.com")||lh.includes("soltfine.com")||lh.includes("silzien.com")
